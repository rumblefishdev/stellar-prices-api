...
> Block Explorer Ledger Processor _specifically_ to serve the Prices API's
...
2. **~~Pair / pool contract registry.~~** **Resolved** by lore 0002 + 0005. Factory-event discovery per venue, with canonical factory /
