...
history:
  ...
  - date: "2026-09-24"
    ...
    who: okarcz
    note: >
      Moved into [[0286]], NOT yet verified — the shared factor was the XLM/USDC daily close printed by
      dust fills (1/17 on 03-11, 4/57 on 03-15; 0276 notes R-production-
      run-2026-09-11.md:151). ADR 0287 / [[0286]] fix it; the dislocation
      stays live until 0286 phase 3 (running on prod) re-ingests and
      pre-rolls, and 0286's still-unchecked "seven dust days within 5 % of
      Bitstamp" criterion is the check. The yBTC
