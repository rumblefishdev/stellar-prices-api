...
status: superseded
related_adr: []
related_tasks: ["0101", "0264", "0176", "0128", "0088"]
...
history:
  ...
  - date: 2026-09-11
    ...
    by: ["0101"]
    note: >
      Folded into [[0101]], which covers the same Soroswap darkness and already
      carries a diagnosed cause for it (the 0096 topic[0] bug, live until the
      2026-07-15 deploy) plus the Phoenix ~2.1% shortfall in the same window.
      This task was filed 2026-09-08 without that connection - its related_tasks
      never referenced 0101 or 0096 - so the two were about to be worked twice.
      Nothing is discarded: the prod measurement is preserved verbatim at
      lore/1-tasks/active/0101_FEATURE_live-era-amm-reprice-gap/notes/R-soroswap-five-day-gap-measured-on-prod.md
      and all five acceptance criteria are merged into 0101's list. 🔴 The one
      fact that did NOT reconcile is now 0101's first move: this task measured
      Soroswap resuming 2026-07-11, 0101 says nothing until 2026-07-15.
---

# Soroswap goes dark for five days, starting at the backfill handoff

> ⛔ **SUPERSEDED 2026-09-11 by [[0101]]** — same gap, and 0101 already carries a
> diagnosed cause plus the tooling, runbook and pre-roll to repair it. Work it
> there. The evidence below is preserved as 0101's
> `notes/R-soroswap-five-day-gap-measured-on-prod.md`; the Implementation and
> Acceptance Criteria sections here are superseded by 0101's.
