...
--   price aggregates are gated on `t.pf_trade_count > 0 AND t.close > 0` — the
--   second term because a PRE-0286 row reads `pf_trade_count` from its DEFAULT
--   (`trade_count`) and can carry a stored price of 0: a DUST-ONLY child —
